...
COPY ["Back/Ellp.Api.UnitTest/Ellp.Api.UnitTest.csproj", "Ellp.Api.UnitTest/"]
COPY ["Back/Ellp.Api.FunctionalTest/Ellp.Api.FunctionalTest.csproj", "Ellp.Api.FunctionalTest/"]
