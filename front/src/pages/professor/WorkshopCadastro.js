  ...
  const cadWorkshops = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/api/Workshop/add",
        workshopData
      );
      ...
      <div className="content login">
        ...
        <div className="inputs">
          <form
            ...
            onSubmit={step === 3 ? cadWorkshops : (e) => e.preventDefault()}
          >
            {step === 1 && (
              <>
            ...
            <div className="buttons">
              {step > 1 && (
                <Button text="Voltar" onClick={prevStep} type="button" />
              )}
              {step < 3 && (
                <Button text="Próximo" onClick={nextStep} type="button" />
              )}
